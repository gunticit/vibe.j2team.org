...
function minimax(b: Board, depth: number, alpha: number, beta: number, maximizing: boolean, aiCol: PieceColor): number {
...
function findBestMove(b: Board, aiCol: PieceColor): { fr: number; fc: number; tr: number; tc: number } | null {
